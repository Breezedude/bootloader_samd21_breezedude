...
copy /y "%UPDATE_UF2%" "%DEST_DIR%\update-bootloader-breezedude-from-v3.16.uf2" >nul
copy /y "%UPDATE_UF2%" "%DEST_DIR%\update-bootloader-breezedude-16k.uf2" >nul
...
echo   - update-bootloader-breezedude-from-v3.16.uf2
echo   - update-bootloader-breezedude-16k.uf2
